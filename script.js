...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const downloadBtn = document.querySelector(".about-text .primary-btn");
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener("click", function (event) {
            ...
            downloadLink.href = "assets/my-cv.pdf"; // Ensure this file exists
            downloadLink.download = "G_V_V_Sai_Ram_CV.pdf"; // File name for download
